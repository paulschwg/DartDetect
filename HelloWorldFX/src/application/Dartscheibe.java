 ...
 * Fl�che f�r Score begrenzt bei 550 und 3950 => 34cm Durchmesser der Punktefl�che
 * (breite, hoehe)
...
public class Dartscheibe {
    ...
    */	
	public int[] getScore(int breite, int hoehe){
		 ...
		 * Math.atan liefert Winkel im Bogenma�, deswegen Umrechnung in Gradma�.
		 * 
		 * Ergebnisse:
		 * Norden (20) = 0�
		 * Osten (6)   = 90�
		 ...
		 * Trifft der Pfeil au�erhalb vom Bullseye aber innerhalb der Wertungszone, wird zus�tzlich der Zahlenwert anhand des Winkels berechnet.
		 */
